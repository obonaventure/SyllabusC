...
.. figure:: ./fig/memoireVirtuelle.png
   :align: center
   :scale: 60
...
Un exemple d'utilisation de `mincore(2)`_ est repris dans le programme :download:`./src/mincore.c` ci-dessous.

.. literalinclude:: ./src/mincore.c
   :encoding: utf-8
   :language: c
   :start-after: ///AAA
